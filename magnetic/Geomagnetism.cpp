...
int MAG_robustReadMagModels(char *filename, MAGtype_MagneticModel ***ptr, int array_size)
{

    typedef MAGtype_MagneticModel* arrtype[array_size];
    arrtype* magneticmodels = (reinterpret_cast<arrtype*>(ptr));
    ...
    fgets(line, MAXLINELENGTH, MODELFILE);
    if(line[0] == '%')
        MAG_readMagneticModel_SHDF(filename, (MAGtype_MagneticModel ***) magneticmodels, array_size);
...
void MAG_PrintSHDFFormat(char *filename, MAGtype_MagneticModel ***ptr, int epochs)
{

    typedef MAGtype_MagneticModel* arrtype[epochs];
    arrtype* MagneticModel = (reinterpret_cast<arrtype*>(ptr));
...
int MAG_readMagneticModel_SHDF(char *filename, MAGtype_MagneticModel ***ptr, int array_size)
/*
