...
#include <stdint.h>
#include <gateway-linux/api/hal/genericIO.h>
...
public:
	 ...
	 * @param stdID CAN ID
	 * @param stdIDmask every bit that is 1 here is don't care
	 * @param extID Can extended ID
	 * @param extIDmask every bit that is 1 here is don't care
	 * @param RTR frame?
	 ...
	 *@param stdID CAN ID
	 *@param extID extended ID(optional)
	 ...
	 * @param stdID CAN ID of received frame
	 * @param extID extended ID
